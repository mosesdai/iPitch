# -*- coding: utf-8 -*-
"""生成 cases/nio/html/research/iceberg.html —— research/*.md 全文镜像（单文件自含 CSS）。

CSS 与 cases/nestle/html/research/iceberg.html 同源（只改 accent 与文案）。
零依赖：内置最小 Markdown 子集渲染器（标题 / 表格 / 列表 / 引用 / 代码块 / 分隔线 / 行内标记）。

用法：python3 cases/nio/build_iceberg.py
"""
...
SRC = CASE / "research"
OUT = CASE / "html" / "research" / "iceberg.html"
...
<title>蔚来 NIO · 冰山深度研究 · v1.6</title>
<style>
{CSS}
</style>
</head>
...
<p class="meta">时间锚：交付至 <strong>2026-06 / Q2-2026（A）</strong> · 损益只到 <strong>Q1-2026（A）</strong> · 姚明×ES9 2026-05-27 · 乐道×申花 2026-01<br/>
MD 真源 <code>../../research/</code> · 会前主材料优先 <a href="../ONE_PAGER.html">ONE_PAGER</a> · <a href="../index.html">索引</a> · <a href="../B_knife.html">10 分钟刀子</a></p>
</header>
<div class="box">
<strong>一句话：</strong>交付斜率是真的（Q2 <strong>107,658</strong>，自算 +49.4%）；乐道 <strong>12,029 → 11,743</strong>，破万的峰值还没变成台阶；GAAP 仍亏 —— 缺的是可核销的<strong>三品牌分层 OS</strong>，不是下一张代言合同。<br/>
<span class="muted">禁句：「连自己的指引都没达到」·「现金 482 亿所以能上大赞助」·「交付新高＝全面复苏」· 粉丝数 / CPM 开场 · 竞品月度排名恐吓 · 用 Q2-2026 损益做任何论证（<strong>未披露</strong>）。</span>
</div>
<div class="box">
<strong>最小真源（A）· 交付与损益分句</strong>
<div class="table-wrap"><table>
<tr><th>口径</th><th>期</th><th>值</th><th>备注</th></tr>
<tr><td rowspan="4">交付（月度 / 季度 A）</td><td>2026-05</td><td>全品牌 37,705 · 蔚来 20,013 · 乐道 12,029 · 萤火虫 5,663</td><td>乐道首次破万</td></tr>
<tr><td>2026-06</td><td>全品牌 40,597 · 蔚来 21,908 · 乐道 11,743 · 萤火虫 6,946</td><td>乐道自算 −2.4%；萤火虫 +22.7%</td></tr>
<tr><td>2026 Q2</td><td><strong>107,658</strong>（对 Q2-2025 的 72,056，自算 +49.4%）</td><td>指引 110,000–115,000 → 自算 −2,342 台 / −2.1%</td></tr>
<tr><td>累计</td><td>1,188,715（至 2026-06-30）</td><td>H1 自算 191,123</td></tr>
<tr><td rowspan="3">损益（季度 A · 只到 Q1）</td><td>2026 Q1</td><td>收入 255.327 亿 · 整车毛利 18.8% · Non-GAAP +0.668 亿 · GAAP −3.321 亿</td><td>交付 83,465（环比 −33.1%）</td></tr>
<tr><td>现金</td><td>482 亿（2026-03-31）</td><td>流动性 ≠ 已批预算</td></tr>
<tr><td>2026 Q2</td><td><strong>未披露</strong></td><td><strong>宁空不编</strong>（写作日 2026-08-09）</td></tr>
</table></div>
</div>
...
<footer>
cases/nio · research/ 全文镜像 · 由 <code>build_iceberg.py</code> 生成，勿手改本文件<br/>
